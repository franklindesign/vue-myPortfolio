<template>
  <div class="grid-container">
    ...
    <div class="grid-item-4 row-title row-bottom-spacing">
    ...
    <div>
      <p>
        <i>Bachelor of Arts (B.A.), Graphic Design</i>
      </p>
      <p>
        <strong>
          <a
...
export default {
  data() {
    return {
      ...
      tools: [
        "Adobe Creative Cloud (Illustrator, Photoshop, InDesign, AfterEffects, XD)",
        "Figma",
        "InVision Studio",
        "Visual Studio Code",
        "Principle",
